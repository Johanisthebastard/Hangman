...
function displayGameResults(sortByDate, ascending = true) {
...
sortButton.addEventListener('click', () => {
	...
	let ascending = sortByDate ? true : false; // Toggle between ascending and descending
	displayGameResults(sortByDate, ascending);
});
